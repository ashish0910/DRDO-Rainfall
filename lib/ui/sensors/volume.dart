...
class _VolumeState extends State<Volume> {
  ...
  Future<dynamic> getData() async {
    var response =  await http.get(
      Uri.encodeFull("https://api.thingspeak.com/channels/811430/fields/6.json?api_key=AJ05PFKIXVX3VA0I"),
      headers: {
    ...
    return Scaffold(
      ...
      body: Center(
        child: !done ? CircularProgressIndicator() : new Center(
          child: Column(
            children: <Widget>[
              Padding( padding: EdgeInsets.only(top: 50), child: Text("Volume",style: TextStyle(fontSize: 50),),),
